...
#startable = soup.findall('table', {"class":"wikitable sortable"})
#star_table = soup.find_all('table', {"class":"wikitable sortable"})
...
#df.to_csv('dwarf_stars.csv', index=True, index_label="id")
#df2.csv('dwarf_stars.csv', index=True, index_label="id")
